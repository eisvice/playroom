"""
Django settings for lazy_accountant project.
...
MIDDLEWARE = [
    ...
    'customers.middleware.TimezoneMiddleware',
]

ROOT_URLCONF = 'lazy_accountant.urls'
...
WSGI_APPLICATION = 'lazy_accountant.wsgi.application'
